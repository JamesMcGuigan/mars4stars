...
public class RaceTech {
  ...
  // Operations
  // @param tech Tech of component
  // @return number of tech levels race exceeds component's requirements for miniturization purposes
  // @param tech 
  public int exceedRequirementsBy ( Tech tech) {
