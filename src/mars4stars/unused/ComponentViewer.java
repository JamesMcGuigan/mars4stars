...
// 
public class ComponentViewer implements ComponentModInterface {
  // Fields
  // 
  private ComponentModInterface vModifier;
  // Methods
  // Constructors
  // Empty Constructor
  public ComponentViewer ( ) { }
  // Accessor Methods
  // Get the value of vModifier
  // 
  // @return the value of vModifier
  private ComponentModInterface getVModifier (  ) {
    return this.vModifier;
  }
  // Set the value of vModifier
  // 
  // 
  private void setVModifier ( ComponentModInterface value  ) {
    this.vModifier = value;
  }
  // Operations
/* (non-Javadoc)
